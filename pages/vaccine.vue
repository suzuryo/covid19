  ...
  <div class="Vaccine">
    ...
    <static-card>
      ...
      <p>
        ...
        <code>ブラウザのリロードボタンを連打しまくるしかない。</code><br />
      </p>
      <h4>予約テクニック</h4>
      <p>
        集団接種会場が出現してみないと分からないが、県のフォームと違ってテクニックは特にない。<br />
        速い安定した固定回線を使い、複数端末や複数人でひたすらリロードして、
        空き枠が出現したらすぐに予約完了まで進めるしかない。
      </p>
      <p>
        9/10 18:00 〜 9/12 09:00
        (予約開始時間の直前)までシステムメンテナンスらしいので、
        初回ログイン時の名前・電話番号・メールアドレスの登録等は、
        メンテ前までに済ませておき、フォームの流れを把握しておくとよい。
      </p>
      ...
      <p>の予約ルートが存在することになる。</p>
      <p>
        その中で、さらに一般枠と優先枠(妊娠されている方およびパートナー・高校3年生・エッセンシャルワーカー等)がある。
      </p>
      <p>
        <app-link
