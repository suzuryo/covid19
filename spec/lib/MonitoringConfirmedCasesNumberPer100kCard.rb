...
def has_monitoring_confirmed_cases_number_per_100k_card(lang:, lang_json:)
  ...
  # DataSet
  # 岩手県全域の直近1週間対人口10万人あたりを算出
  d = DATA_JSON['patients']['data'].filter{|i| Time.parse(i['確定日']) > Time.parse(POSITIVE_RATE_JSON['data'].last['diagnosed_date']).days_ago(7)}.size * 100000.0 / 1211206
